# NextGen Wealth Advisor Project Context (Ruby-Focused Version, v1.3 - January 02, 2026)
...
1. **Core Vision**
    - Build a “virtual family office” for families with $5M–$50M net worth who are too small for a real family office.
...
2. **Technical Architecture (Current Decision)**
    - Language / Framework: Ruby on Rails 8 (upgraded for Solid Queue defaults, enhanced MVC/testing).
    - Database: Single PostgreSQL instance with Row-Level Security (RLS) for multi-user isolation (no per-user DBs).
    - Sensitive data: column-level encryption via attr_encrypted (especially Plaid access_tokens).
    ...
    - Chat/Support: Chatwoot integration for conversational UI (e.g., query handling via webhooks to agents; supports handoffs to Ollama for responses, with audit trails).
...
3. **Plaid Data Model (agreed schema)**  
   ...
   **Update Type: Semi-dynamic—check repo for migrations via browse_page on db/schema.rb.**
   ...
   Transaction:
     ...
     fields: {transaction_id: string, amount: decimal, date: date, description: string, enriched_category: string} # Example enrichment
   Holding:
     associations: belongs_to :account
...
4. **AI / RAG Strategy (Rails-native, no Python needed)**
    - Daily cron job → FinancialSnapshotJob creates a sanitized JSON blob per user (totals, allocations, overdue tasks, risk scores, etc.) via Solid Queue.
...
|----------|--------------|--------|--------------|-------------|
| 12 | Setup New Rails 8 App with Core Gems (plaid-ruby, devise, attr_encrypted, sidekiq, webmock, vcr, solid_queue) | Todo | None | knowledge_base/static_docs/rails_setup.md (assumed) |
| 13 | Implement Devise Authentication with User Model and RLS Policies | Todo | #12 | knowledge_base/prds/PRD UC-14.md |
| 14 | Create Plaid Sandbox Link Token Generation | Todo | #13 | knowledge_base/prds/PRD CSV-02.md |
| 15 | Implement Public Token Exchange and Encrypted Storage in PlaidItem Model | Todo | #14 | knowledge_base/prds/PRD CSV-03.md |
| 16 | Build Basic Sync Service for Accounts, Transactions, and Holdings | Todo | #15 | knowledge_base/prds/PRD CSV-05.md |
| 17 | Add Sandbox Testing and Real Bank Link Support | Todo | #16 | knowledge_base/prds/PRD CSV-06.md |
| 18 | Implement Daily FinancialSnapshotJob for JSON Blobs (Solid Queue) | Todo | #17 | knowledge_base/epics/full-fetch.md |
| 19 | Create AiFinancialAdvisor Service for Local Ollama Integration | Todo | #18 | knowledge_base/epics/agents.md |
| 20 | Add Core Context Files (0_AI_THINKING_CONTEXT.md, PRODUCT_REQUIREMENTS.md) | Todo | #19 | knowledge_base/static_docs/0_AI_THINKING_CONTEXT.md |
| 21 | Implement Investments/Holdings/Get Endpoint Sync | Todo | #20 | knowledge_base/prds/PRD PROD-TEST-01.md |
| 22 | Implement Transactions/Get Endpoint Sync | Todo | #21 | knowledge_base/epics/Investment-Enrichment.md |
| 23 | Implement Liabilities/Get Endpoint Sync | Todo | #22 | knowledge_base/epics/Local-Transaction-Enrichment.md |
| 24 | Implement Enrichment Features (e.g., Categorization) | Todo | #23 | knowledge_base/static_docs/enrichment.md |
| 25 | Setup CSV Import/Export for Data Mocking/Anonymization | Todo | #24 | knowledge_base/prds/PRD-Backlog.md |
| 28 | Agent-05 Epic: Multi-Agent Basics (Persona Setup, Feedback, Planning, Tools, UI) | Todo | None | knowledge_base/epics/AGENT-05.md (spike in 0010) |
| 29 | Agent-05 PRD 0010: Persona Setup & Console Handoffs | Todo | #28 | knowledge_base/prds/PRD-0010.md |
| 30 | Agent-05 PRD 0020: Feedback & Resolution Loop | Todo | #29 | knowledge_base/prds/PRD-0020.md |
| 31 | Agent-05 PRD 0030: Planning Phase for CWA | Todo | #30 | knowledge_base/prds/PRD-0030.md |
| 32 | Agent-05 PRD 0040: Impl/Test/Commit with CWA | Todo | #31 | knowledge_base/prds/PRD-0040.md |
| 33 | Agent-05 PRD 0050: UI Layer & Tracking | Todo | #32 | knowledge_base/prds/PRD-0050.md |
| 34 | Agent-06 Epic: Advanced CWA (Persona/Toolkit, Logs, MCP Tools, Self-Debug, Workflow Handoff) | Todo | Agent-05 | knowledge_base/epics/AGENT-06.md |
| 35 | Agent-06 PRD 0010: CWA Persona & Safe Shell Toolkit | Todo | #34 | knowledge_base/prds/PRD-0010.md |
| 36 | Agent-06 PRD 0020: Task Log Template & Persistence | Todo | #35 | knowledge_base/prds/PRD-0020.md |
| 37 | Agent-06 PRD 0030: MCP-Like Tools Integration | Todo | #36 | knowledge_base/prds/PRD-0030.md |
| 38 | Agent-06 PRD 0040: Self-Debug Loop | Todo | #37 | knowledge_base/prds/PRD-0040.md |
| 39 | Agent-06 PRD 0050: Workflow Integration & Hybrid Handoff | Todo | #38 | knowledge_base/prds/PRD-0050.md |
